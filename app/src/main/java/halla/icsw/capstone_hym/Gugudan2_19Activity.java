...
public class Gugudan2_19Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gugudan2_19);
        ...
        //Gugudan_Study2_Activity에서 Intent 값 받아옴
    ...
    public void leftOnclick(View view) {
        ...
        for (dan = 2; dan <= 19; dan++) {
            if (danName.equals(dan + " 단")) {
                ...
                if(btRightCount>=0) {
                    dan += btRightCount;
                    if ((dan <= 19 && dan>=2 ) || (btRightCount+dan <=19 && btRightCount+dan>=2)) {
