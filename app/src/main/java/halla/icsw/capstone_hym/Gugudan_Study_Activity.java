...
public class Gugudan_Study_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gugudan__study_);

        danText = findViewById(R.id.danText);
        listView = findViewById(R.id.listView);
        danList = new String[8];
        ...
        // 2단~9단 리스트뷰에 뿌리기 위해 ArrayAdapter 사용
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent intent = new Intent(Gugudan_Study_Activity.this, Gugudan2_9Activity.class);
